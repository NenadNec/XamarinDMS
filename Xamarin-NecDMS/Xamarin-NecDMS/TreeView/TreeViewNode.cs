...
namespace NecDMS.TreeView
{
    public class TreeViewNode : StackLayout
    {
        ...
        internal readonly BoxView SelectionBoxView = new BoxView { Color = Color.Gray, Opacity = .5, IsVisible = false };
        #endregion
        ...
        private void SetExpandButtonContent(DataTemplate expandButtonTemplate)
        {
            ...
            {
                _ExpandButtonContent.Content = (Xamarin.Forms.View)expandButtonTemplate.CreateContent();
            }
            else
            {
                _ExpandButtonContent.Content = (Xamarin.Forms.View)new ContentView { Content = _EmptyBox };
            }
        }
        #endregion
